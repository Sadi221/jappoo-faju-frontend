          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold rounded-2xl hover:shadow-2xl hover:shadow-blue-500/40 transition-all transform hover:scale-105 flex items-center justify-center space-x-2">
                  <Heart size={20} fill="white" />
                  <span>Faire un don maintenant</span>
                  <ArrowRight className="group-hover:translate-x-1 transition-transform" size={20} />
                </button>
                
                <button className="px-8 py-4 bg-white border-2 border-blue-200 text-blue-600 font-bold rounded-2xl hover:bg-blue-50 transition-all flex items-center justify-center space-x-2">
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 space-y-6 border border-blue-100">
                ...
                <button className="w-full py-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold rounded-xl hover:shadow-xl hover:shadow-blue-500/30 transition-all transform hover:scale-105 flex items-center justify-center space-x-2">
                  <Heart size={20} fill="white" />
